...
namespace SLouple.MVC.Shared
{
    public class Lang
    {
        ...
        public Lang(int langID)
        {
            ...
            this.langID = langID;
            this.langName = sqlSP.LangGetLangName(this.langID);
        }
        ...
        public Lang(string langName)
        {
            ...
            this.langID = sqlSP.LangGetLangID(this.langName);
        }
        ...
        public string GetLangCode()
        {
            ...
            {
                SqlStoredProcedures sqlSP = new SqlStoredProcedures();
                this.langCode = sqlSP.LangGetLangCode(this.langID);
            }
            return langCode;
        }
        ...
        public void GetTranslationFromSQL()
        {
            ...
            SqlStoredProcedures sqlSP = new SqlStoredProcedures();
            string contextString = sqlSP.LangGetTranslation(langID, "SL_MVC", keywordString);
