...
BEGIN
	...
	BEGIN
		EXEC Support.uspGetTicketCategoryID @TicketCategoryName = @TicketCategoryName, @TicketCategoryID = @TicketCategoryID OUTPUT
	END
	IF @Rating > 10
	BEGIN
		SET @Rating = 10;
	...
	BEGIN
		SET @Rating = 0;
	END
	INSERT INTO Support.Ticket (TicketTitle, TicketCategoryID, Rating, Comment, Email, PhoneNumber, Name) VALUES
