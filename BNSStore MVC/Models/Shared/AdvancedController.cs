    ...
    public class AdvancedController : Controller
    {
        ...
        public void LoadLanguage()
        {
            try
            {
                ...
                {
                    this.lang = new Lang(user.GetMainLang().GetLangID());
                }
                else
                {
        ...
        public new ActionResult RedirectToAction(string actionName, string controllerName)
        {
            ...
            {
                return Redirect(protocol + "slouple.com/" + actionName + "/");
            }
            return Redirect(protocol + controllerName + ".slouple.com/" + actionName + "/");
        }
